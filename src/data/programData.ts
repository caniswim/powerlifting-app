...
function day(dayType: DayType, label: string, exercises: PrescribedExercise[]): PrescribedDay {
...
function rpeProgression4(weekIdx: number): string {
...
function volScale4(base: number, weekIdx: number): number {
...
function accSquatDay(weekIdx: number, opts?: {
...
function accBenchDay(weekIdx: number, opts?: {
  mainSets?: number; mainReps?: string; mainRpe?: string;
...
function accDeadliftDay(weekIdx: number, opts?: {
  mainSets?: number; mainReps?: string; mainRpe?: string;
...
function accBenchVolDay(weekIdx: number, opts?: {
...
function deloadSquatDay(): PrescribedDay {
...
function deloadBenchDay(): PrescribedDay {
...
function deloadDeadliftDay(): PrescribedDay {
...
function deloadBenchVolDay(): PrescribedDay {
...
function buildMac1(): PrescribedWeek[] {
...
function buildMac2(): PrescribedWeek[] {
  const weeks: PrescribedWeek[] = [];
...
function buildMac3(): PrescribedWeek[] {
  const weeks: PrescribedWeek[] = [];
...
function buildMac4(): PrescribedWeek[] {
  const weeks: PrescribedWeek[] = [];
